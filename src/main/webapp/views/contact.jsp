...
<body>
    ...
    <!-- Card 1 -->
    <h4>We will get back to you. Please leave your email:</h4>
    <input type="email" name="email" placeholder="abc@domain.name" required>
   <button name="submit" onclick="csuccess()">Submit</button>
